...
public struct RainbowBlurPixelModel: PixelSingleEffectModel {
    ...
    public var style: RainbowBlurPIX.RainbowBlurStyle = .zoom
    ...
    public init(from decoder: Decoder) throws {
        ...
        if try PixelModelDecoder.isLiveListCodable(decoder: decoder) {
            ...
            for codingKey in CodingKeys.allCases {
                ...
                switch codingKey {
                case .style:
                    guard let live = liveWrap as? LiveEnum<RainbowBlurPIX.RainbowBlurStyle> else { continue }
        ...
        style = try container.decode(RainbowBlurPIX.RainbowBlurStyle.self, forKey: .style)
