...
//
//float2 starLerp2d(float fraction, float2 from, float2 to) {
...
////}
//
//float2 startProportion(float2 point, float segment, float length, float dx, float dy) {
...
//};
//
//CornerCircle starCornerCircle(float2 p, float2 p1, float2 p2, float r) {
//    
//    //Vector 1
//    float dx1 = p.x - p1.x;
//    float dy1 = p.y - p1.y;
